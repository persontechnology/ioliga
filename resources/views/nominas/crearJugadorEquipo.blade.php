...
@section('breadcrumbs', Breadcrumbs::render('Crear-equipos-jugador',$equipo))
@section('acciones')  
  <a href="{{ route('listado-jugadores-nomina',$equipo->id)}}" class="breadcrumb-elements-item">
...
<div class="card">
  <div class="card-body">
    <form action="{{ route('guardar-jugador-equipo') }}" method="post" enctype="multipart/form-data" id="formIngresoUsuario">
      @csrf
      <div class="row">
          <div class="col-md-6">
              <fieldset>
