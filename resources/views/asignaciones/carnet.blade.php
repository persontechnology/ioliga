				...
				<tr >					
					<td class="">					
						...
						@if(isset($asiNO->unoNomina->user->foto))
							<img class="card-img" style="border-radius: 10px; border: 1; border-color: #84B3C9" src="{{public_path('/storage/usuarios/'.$asiNO->unoNomina->user->foto) }}" alt=""width="120px;;"  height="153px;" />
						@else
							 <img class="card-img" src="" alt=""width="120px;;"  height="153px;" />
						@endif					
					</td>
					<td>
