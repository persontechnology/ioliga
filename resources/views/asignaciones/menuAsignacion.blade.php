			...
			<div class="row">
				...
				<div class="col-sm-6 col-xl-4">
					<div class="card card-body bg-blue-800 has-bg-image">
						<div class="media">
							<div class="media-body">
							<a class="text-white" href="{{route('etapas-equipo',Crypt::encryptString($asignacion->id))}}">
								<h3 class="mb-0">Etapas</h3>
								<span class="text-uppercase font-size-xs">Tabla de posiciones</span>
							</a>
							</div>
				...
				<div class="col-sm-6 col-xl-4">
					<div class="card card-body bg-success-400 has-bg-image">
						<div class="media">
							...
							<a class="text-white" href="{{route('fechas-representante',Crypt::encryptString($asignacion->id))}}">
							<div class="media-body text-right">
								<h3 class="mb-0">Mis</h3>
								<span class="text-uppercase font-size-xs">Calendarios</span>
							</div>
							</a>
						</div>
					</div>
